...
/** Class GradeTestStudentCodingController is a controller class which allows the user to edit individual grades for coding questions
 *  Class GradeTestStudentCodingController has the methods SetUpTest, ShowQuestionValue, and changeGradeValue.
 *  Class GradeTestStudentCodingController invokes many button clicks and uses the Grader, Test, and Question class to get its data.
 */
public class GradeTestStudentCodingController {
	...
	private void SetUpTest() {
		CodingQuestion newQuestion = (CodingQuestion) questionTable.getItems().get(questIndex);
		CodingAnswer answer = newQuestion.GetActualAnswer();
