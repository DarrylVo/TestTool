...
public class TakeTestWrittenController {

	@FXML
	Main main;
	@FXML
	GridPane questionView;
	@FXML
	...
	public TakeTestWrittenController() {
	...
	private void handleNextQuestion() {
		if (writtenAnswer.getText() != null && !writtenAnswer.getText().isEmpty()) {
			((WrittenResponseQuestion) viewTest.getCurrentQuestion()).SetStudentAnswer(writtenAnswer.getText());
